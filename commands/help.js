...
module.exports = {
  name: "help",
  description: "Information about the Ikuyo Kita",
  usage: "[command]",
  permissions: {
  ...
  Ikuyo Kita Bot Version: v${require("../package.json").version}
  [✨ Support Server](${
    client.botconfig.SupportServer
  }) | [GitHub](https://github.com/vlnz) | [Dashboard](${
      client.botconfig.Website
    }) | By [Fiyu](https://github.com/vlnz)`);
